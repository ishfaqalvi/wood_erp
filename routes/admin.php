...
|--------------------------------------------------------------------------
*/
Route::prefix('item')->namespace('\App\Http\Controllers\Admin\Item')->group(__DIR__.'/item.php');
...
|--------------------------------------------------------------------------
*/
Route::prefix('purchasing')->namespace('\App\Http\Controllers\Admin\Purchasing')->group(__DIR__.'/purchasing.php');
...
|--------------------------------------------------------------------------
*/
Route::prefix('banking')->namespace('\App\Http\Controllers\Admin\Banking')->group(__DIR__.'/banking.php');
