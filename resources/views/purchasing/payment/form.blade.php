<div class="row">
    ...
    <div class="form-group col-lg-6 mb-3">
        {{ Form::label('قسم  ') }}
        {{ Form::select('type', ['Cash' => 'Cash','Online' => 'Online','Check' => 'Check'], $purchasePayment->type, ['class' => 'form-control select' . ($errors->has('type') ? ' is-invalid' : ''), 'placeholder' => '--منتخب کریں۔--','required']) }}
        {!! $errors->first('type', '<div class="invalid-feedback">:message</div>') !!}
    </div>
    <div class="form-group col-lg-6 mb-3 bank" style="display: none;">
        {{ Form::label('بینک  ') }}
        {{ Form::text('bank', $purchasePayment->bank, ['class' => 'form-control' . ($errors->has('bank') ? ' is-invalid' : ''), 'placeholder' => 'بینک  ']) }}
