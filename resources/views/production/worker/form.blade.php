<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group mb-3">
            {{ Form::label('ای میل') }}
            {{ Form::text('email', $worker->email, ['class' => 'form-control' . ($errors->has('email') ? ' is-invalid' : ''), 'placeholder' => 'ای میل']) }}
            {!! $errors->first('email', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group mb-3">
            {{ Form::label('فون') }}
            {{ Form::text('phone', $worker->phone, ['class' => 'form-control' . ($errors->has('phone') ? ' is-invalid' : ''), 'placeholder' => 'فون','required']) }}
    ...
    <div class="form-group col-md-12 mb-3">
        {{ Form::label('پتہ') }}
        {{ Form::text('address', $worker->address, ['class' => 'form-control' . ($errors->has('address') ? ' is-invalid' : ''), 'placeholder' => 'پتہ','required']) }}
