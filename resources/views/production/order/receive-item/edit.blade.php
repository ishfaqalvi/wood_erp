        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('order.receive.items.update', $item->id) }}" class="validate" role="form" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">آرڈر پلان آئٹم کو اپ ڈیٹ کریں۔</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group mb-3">
                            {{ Form::label('مصنوعات کی مقدار') }}
                            {{ Form::text('product_quantity', $item->product_quantity, ['class' => 'form-control' . ($errors->has('product_quantity') ? ' is-invalid' : ''), 'placeholder' => 'مصنوعات کی مقدار','required','min'=>'0']) }}
