<div class="row">
    ...
    <div class="form-group col-lg-6 mb-3">
        {{ Form::label('account') }}
        {{ Form::select('account_id', accounts(), $transaction->account_id, ['class' => 'form-control form-select' . ($errors->has('account_id') ? ' is-invalid' : ''), 'placeholder' => '--منتخب کریں۔--','required']) }}
