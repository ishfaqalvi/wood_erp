<div class="row">
    ...
    <div class="form-group col-lg-12">
        {{ Form::label('roles') }}
        {{ Form::select('roles[]', $roles, $user->roles, ['class' => 'form-control select m-b-10 select2-multiple' . ($errors->has('roles') ? ' is-invalid' : ''), 'data-placeholder' => '--منتخب کریں۔--','multiple','required']) }}
