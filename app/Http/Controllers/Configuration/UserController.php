...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('configuration.users.create',compact('roles','user'));
    }
    ...
    {
        $user = User::find($id);
        return view('configuration.users.show', compact('user'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('configuration.users.edit',compact('user','roles','userRole'));
    }
