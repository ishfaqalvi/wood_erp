...
class PurchaseItemController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('item.purchase.create', compact('purchaseItem'));
    }
    ...
    public function show($id)
    {
        ...
        return view('item.purchase.show', compact('purchaseItem'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('item.purchase.edit', compact('purchaseItem'));
    }
