...
class VendorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('purchasing.vendor.index', compact('vendors'));
    }
    ...
    {
        $vendor = new Vendor();
        return view('purchasing.vendor.create', compact('vendor'));
    }
    ...
    public function show($id)
    {
        ...
        return view('purchasing.vendor.show', compact('vendor'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('purchasing.vendor.edit', compact('vendor'));
    }
