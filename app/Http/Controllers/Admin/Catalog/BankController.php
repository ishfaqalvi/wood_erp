...
class BankController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.catalog.bank.index', compact('banks'));
    }
    ...
    {
        $bank = new Bank();
        return view('admin.catalog.bank.create', compact('bank'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.catalog.bank.show', compact('bank'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.catalog.bank.edit', compact('bank'));
    }
